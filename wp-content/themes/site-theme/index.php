						...
						<div class="mod-uneven-column eq-height">
							...
							<div class="right-column item-eq-height">
								<div class="column-inner">
									<h4 class="heading03">一人ひとりの個性に合わせて一貫したサポートを</h4>
									<p class="text">私たちは、<strong>高齢者トータルサポート</strong>、<strong>不動産紹介</strong>、<strong>人材紹介</strong>、<strong>就労継続支援</strong>の4つの事業を行っております。関わる皆様には実際にお会いし、ご経験やご要望等を全てお伺いしたうえで、ミスマッチのない最適なご提案をいたします。<br>
										高齢期の暮らしには、住まい探し、お引越し、日々の生活、そしてご家族の働き方まで、たくさんの「困りごと」が折り重なっています。窓口がばらばらでは、ご本人もご家族も、支援する事業者の皆さまも疲れてしまう。私たちは、その一つひとつを切り離さず、輪のようにつないで支えていきます。
									</p>
								</div>
							</div>
						</div>
