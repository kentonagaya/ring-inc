						...
						<div class="mod-uneven-column eq-height">
							...
							<div class="right-column item-eq-height">
								<div class="column-inner">
									<h4 class="heading03">>一人一人の個性に合わせて一貫したサポートを</h4>
									<p class="text">たちは、高齢者トータルサポート、不動産紹介、人材紹介、就労継続支援の4つの事業を行っております。関わる皆様には実際にお会いし、ご経験やご要望等を全てお伺いしたうえで、ミスマッチのない最適なご提案をいたします。
