			...
			<div class="fixedmenu <?php if( $header_type == 'gnav' ){ echo 'header-gnav-in'; };?>">
				...
				<div class="side-contents"><!-- side-contents -->
					...
					<nav class="mod-sidenav-standard">
						<ul>
							<li>
								<a <?php if ( is_page('contact') ) { echo ' class="current" '; } ?> href="<?php bloginfo('url'); ?>/<?php echo CURRENTDIR;?>/">お問い合わせ</a>
							</li>
							<li>
								<a <?php if ( is_page('privacy') ) { echo ' class="current" '; } ?> href="<?php bloginfo('url'); ?>/<?php echo CURRENTDIR;?>/privacy/">個人情報保護方針</a>
							</li>
						</ul>
					</nav>
